...
class GloveHandle(threading.Thread):
    ...
    def __readPackage(self):
        ...
        if not self._nonBlocking:
            while self._newFrameLock or self._imuFrameLock or self._deformationFrameLock:
                time.sleep(0.001)
